...
QT_MOC_LITERAL(1, 11, 12), // "zoom_changed"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 11) // "change_zoom"

    },
    "MyGLWidget\0zoom_changed\0\0change_zoom"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->zoom_changed((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->change_zoom((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGLWidget::zoom_changed)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyGLWidget::zoom_changed(int _t1)
{
