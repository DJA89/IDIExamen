...
{
  glm::mat4 TG(1.f);  // Matriu de transformació
  TG = glm::translate(TG, glm::vec3(0, 2, 0)); //trasladamos al Patricio  nuevo una altura de Patricio hacia arriba
  TG = glm::rotate(TG, float(M_PI), glm::vec3(0, 0, 1));// Rotamos para que quede de abceza 180 grados respecto al eje z
  TG = glm::scale(TG, glm::vec3(escala, escala, escala));
  TG = glm::translate(TG, -centrePatr);
