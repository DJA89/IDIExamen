...
public:
    ...
    void setupUi(QWidget *MyForm)
    {
        ...
        QObject::connect(verticalSlider, SIGNAL(valueChanged(int)), widget, SLOT(change_zoom(int)));
        QObject::connect(widget, SIGNAL(zoom_changed(int)), verticalSlider, SLOT(setValue(int)));
