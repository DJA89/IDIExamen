...
void MyGLWidget::projectTransform ()
{
  ...
  if(secondCam == true){ // ***** PARA LA SEGUNA CAMARA, EL ZN Y ZF LOS PONGO GRANDES PARA QUE NUNCA RECORTEN *****
       Proj = glm::perspective((float)M_PI/3.0f, ra, 0.1f, 20.0f);
  }
  else{
      if (perspectiva)
...
void MyGLWidget::viewTransform ()
{
  ...
  if(secondCam == false){
      ...
      glm::vec4 posicion = glm::vec4(glm::vec3(1,-0.375,0), 1.0f);
      // ***** APLICAMOS UNA TRANSFORMACION GEOMETRICA A LA POSICION A LA QUE MIRAMOS *****
      posicion = glm::rotate(glm::mat4(1.f),rotacionAdicional, glm::vec3(0,1,0))*posicion;
      View = glm::lookAt(glm::vec3(-1,1,-1),glm::vec3(posicion), glm::vec3(0,1,0));
  }
...
void MyGLWidget::keyPressEvent(QKeyEvent* event) 
{
  ...
  case Qt::Key_C: { // ***** YA NO CAMBIAMOS LA CAMARA *****
    /*secondCam = !secondCam;
    viewTransform();
    projectTransform();
    update();*/
