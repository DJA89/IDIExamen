...
vec3 colFocus = vec3(0.8, 0.8, 0.8); // ***** CAMBIO EL COLOR CIAN, ME MAERA *****
...
{	
    ...
    vec4 posFocusSCO = vec4(posFocus,1.0); // ***** NO MULTIPLICAMOS LA POSICIÓN DEL FOCO POR LA VIEW YA QUE QUEREMOS QUE SEA DE CAMARA
