...
QT_MOC_LITERAL(4, 41, 9), // "changeFOV"
QT_MOC_LITERAL(5, 51, 11) // "changeFocus"

    },
    "MyGLWidget\0updateFOVSlider\0\0focusChanged\0"
    "changeFOV\0changeFocus"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGLWidget::updateFOVSlider)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGLWidget::focusChanged)) {
                *result = 1;
                return;
            }
        }
