...
class MyGLWidget : public QOpenGLWidget, protected QOpenGLFunctions_3_3_Core 
{
  ...
  private:
    ...
    // ***** PARA EL PATRON CEBRADO *****
    GLuint paintZebraLoc;
    float hasToPaintZebra;

    // ***** PARA EL CAMBIO DE FOCO *****
    GLuint changeFocusLoc;
    float focusStatus;

    // ***** PARA MOVER EL PATRICIO *****
    float quanity;

    // ***** PARA EL FOCO NUEVO *****
    GLuint focus2Loc;

    // ***** PARA EL CAMBIO DE COLOR DEL SUELO *****
    glm::vec3 colorSuelo;
};
