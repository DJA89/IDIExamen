...
void MyGLWidget::iniEscena ()
{
  ...
  radiEsc = glm::distance(glm::vec3(-2.0,-1.0,-2.0), glm::vec3(2.0,4,2.0))/2.0;
}
...
void MyGLWidget::iniCamera ()
{
  ...
  vrp = glm::vec3(0,1,0); // ***** RECORDAMOS QUE EL SUELO ESTA EN LA POS -1 *****
