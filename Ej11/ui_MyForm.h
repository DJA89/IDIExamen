...
public:
    ...
    void setupUi(QWidget *MyForm)
    {
        ...
        QObject::connect(widget, SIGNAL(whiteLightToggled(bool)), radioButton, SLOT(setChecked(bool)));
        QObject::connect(widget, SIGNAL(cyanLightToggled(bool)), radioButton_2, SLOT(setChecked(bool)));
        QObject::connect(radioButton, SIGNAL(toggled(bool)), widget, SLOT(ToggleWhiteLight(bool)));
        QObject::connect(radioButton_2, SIGNAL(toggled(bool)), widget, SLOT(ToggleCyanLight(bool)));
