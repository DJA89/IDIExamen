...
class MyGLWidget : public QOpenGLWidget, protected QOpenGLFunctions_3_3_Core
{
  ...
  public slots:
    void ToggleWhiteLight(bool);
    void ToggleCyanLight(bool);
  signals:
    void whiteLightToggled(bool);
    void cyanLightToggled(bool);
  private:
    void ChangeWhiteLight();
    ...
    // uniform locations
    GLuint transLoc, projLoc, viewLoc, pintaMooLoc, realLightLoc, whiteLightLoc;
    // attribute locations
